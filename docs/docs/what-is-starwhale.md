...
Starwhale is an MLOps platform for model evaluation. It aims to create a handy tool for data scientists and machine learning engineers.

Starwhale helps you
* Run trained models in different environments and show the evaluation results.
* View your datasets in a human-friendly way.
